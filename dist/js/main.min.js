 ...
 */
(()=>{var t,n,e;const r=Symbol(),o=Symbol(),i=Symbol(),u=Symbol(),c=Symbol(),a=Symbol(),f=Symbol(),s=Symbol(),l=Symbol(),h=Symbol(),d=Symbol(),v=Symbol(),p=Symbol();class y{constructor(){this[t]=[],this[n]=[],this[e]=new Set}destructor(){this[l](this[i]);this[r]=null,this[i]=null,this[o]=null}get top(){const t=this[r];return t[t.length-1]||null}push(t){t&&t!==this.top&&(this.remove(t),this[a](t),this[r].push(t))}remove(t){const n=this[r].indexOf(t);return-1!==n&&(this[r].splice(n,1),n===this[r].length&&this[a](this.top),!0)}pop(){const t=this.top;return t&&this.remove(t),t}has(t){return-1!==this[r].indexOf(t)}[(t=r,n=i,e=o,a)](t){const n=this[o],e=this[i];if(!t)return this[l](e),n.clear(),void(this[i]=[]);const r=this[h](t);if(r[r.length-1].parentNode!==document.body)throw Error("Non-connected element cannot be a blocking element");this[i]=r;const u=this[d](t);if(!e.length)return void this[s](r,u,n);let c=e.length-1,a=r.length-1;for(;c>0&&a>0&&e[c]===r[a];)c--,a--;e[c]!==r[a]&&this[f](e[c],r[a]),c>0&&this[l](e.slice(0,c)),a>0&&this[s](r.slice(0,a),u,null)}[f](t,n){const e=t[u];this[v](t)&&!t.inert&&(t.inert=!0,e.add(t)),e.has(n)&&(n.inert=!1,e.delete(n)),n[c]=t[c],n[u]=e,t[c]=void 0,t[u]=void 0}[l](t){for(const n of t){n[c].disconnect(),n[c]=void 0;const t=n[u];for(const n of t)n.inert=!1;n[u]=void 0}}[s](t,n,e){for(const r of t){const t=r.parentNode,o=t.children,i=new Set;for(let t=0;t<o.length;t++){const u=o[t];u===r||!this[v](u)||n&&n.has(u)||(e&&u.inert?e.add(u):(u.inert=!0,i.add(u)))}r[u]=i;const a=new MutationObserver(this[p].bind(this));r[c]=a;let f=t;const s=f;s.__shady&&s.host&&(f=s.host),a.observe(f,{childList:!0})}}[p](t){const n=this[i],e=this[o];for(const r of t){const t=r.target.host||r.target,o=t===document.body?n.length:n.indexOf(t),i=n[o-1],c=i[u];for(let t=0;t<r.removedNodes.length;t++){const n=r.removedNodes[t];if(n===i)return console.info("Detected removal of the top Blocking Element."),void this.pop();c.has(n)&&(n.inert=!1,c.delete(n))}for(let t=0;t<r.addedNodes.length;t++){const n=r.addedNodes[t];this[v](n)&&(e&&n.inert?e.add(n):(n.inert=!0,c.add(n)))}}}[v](t){return!1===/^(style|template|script)$/.test(t.localName)}[h](t){const n=[];let e=t;for(;e&&e!==document.body;)if(e.nodeType===Node.ELEMENT_NODE&&n.push(e),e.assignedSlot){for(;e=e.assignedSlot;)n.push(e);e=n.pop()}else e=e.parentNode||e.host;return n}[d](t){const n=t.shadowRoot;if(!n)return null;const e=new Set;let r,o,i;const u=n.querySelectorAll("slot");if(u.length&&u[0].assignedNodes)for(r=0;r<u.length;r++)for(i=u[r].assignedNodes({flatten:!0}),o=0;o<i.length;o++)i[o].nodeType===Node.ELEMENT_NODE&&e.add(i[o]);return e}}document.$blockingElements=new y})(),window.matchMedia("(max-width: 768px)").matches){const t=document.querySelector(".page__body"),n=document.querySelector(".menu"),e=document.querySelector(".menu__button"),r=document.querySelector(".menu__body");let o=()=>{e.setAttribute("aria-expanded",!0),e.classList.add("menu__button_active"),r.classList.add("menu__body_open"),t.classList.add("page__body_lock"),r.inert=!1,makeBlocking(n)},i=()=>{e.setAttribute("aria-expanded",!1),e.classList.remove("menu__button_active"),r.classList.remove("menu__body_open"),t.classList.remove("page__body_lock"),r.inert=!0,undoBlocking(n)};e.addEventListener("click",()=>{"true"===e.getAttribute("aria-expanded")||!1?i():o()}),i()}